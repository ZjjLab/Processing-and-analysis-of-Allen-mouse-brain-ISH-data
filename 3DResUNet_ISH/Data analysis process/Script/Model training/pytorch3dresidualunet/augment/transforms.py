...
class Transformer:
    ...
    def CA1_transform(self):
        return self._create_transform('CA1')

    def CA2_transform(self):
        return self._create_transform('CA2')

    def CA3_transform(self):
        return self._create_transform('CA3')

    def DG_transform(self):
        return self._create_transform('DG')

    def MASK_transform(self):
        return self._create_transform('MASK')
