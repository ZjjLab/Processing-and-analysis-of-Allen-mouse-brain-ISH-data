...
class AbstractHDF5Dataset(ConfigDataset):
    ...
    def __init__(self, file_path,
        ...
        if phase != 'test':
            ...
            self.CA1 = self.fetch_and_check(input_file, CA1_internal_path)
            self.CA1_transform = self.transformer.CA1_transform()

            self.CA2 = self.fetch_and_check(input_file, CA2_internal_path)
            self.CA2_transform = self.transformer.CA2_transform()

            self.CA3 = self.fetch_and_check(input_file, CA3_internal_path)
            self.CA3_transform = self.transformer.CA3_transform()

            self.DG = self.fetch_and_check(input_file, DG_internal_path)
            self.DG_transform = self.transformer.DG_transform()

            # self.mask = self.fetch_and_check(input_file, mask_internal_path)
            # self.mask_transform = self.transformer.mask_transform()
        ...
        slice_builder = get_slice_builder(self.raw,self.label,self.CA1,self.CA2,self.CA3,self.DG,self.MASK, self.weight_map, slice_builder_config) #
        self.raw_slices = slice_builder.raw_slices
        self.label_slices = slice_builder.label_slices
        self.CA1_slices = slice_builder.CA1_slices
        self.CA2_slices = slice_builder.CA2_slices
        self.CA3_slices = slice_builder.CA3_slices
        self.DG_slices = slice_builder.DG_slices
        # self.mask_slices = slice_builder.mask_slices
        self.MASK_slices = slice_builder.MASK_slices
        self.weight_slices = slice_builder._weight_slices
    ...
    def __getitem__(self, idx):
        ...
        if self.phase == 'test':
            ...
            CA1_idx = self.CA1_slices[idx]
            CA1_patch_transformed = self.CA1_transform(self.CA1[CA1_idx])
            CA2_idx = self.CA2_slices[idx]
            CA2_patch_transformed = self.CA2_transform(self.CA2[CA2_idx])
            CA3_idx = self.CA3_slices[idx]
            CA3_patch_transformed = self.CA3_transform(self.CA3[CA3_idx])
            DG_idx = self.DG_slices[idx]
            DG_patch_transformed = self.DG_transform(self.DG[DG_idx])
            ...
            if self.weight_map is not None:
                ...
                return raw_patch_transformed, label_patch_transformed, weight_patch_transformed,CA1_patch_transformed,CA2_patch_transformed,CA3_patch_transformed,DG_patch_transformed,MASK_patch_transformed
            # return the transformed raw and label patches
            return raw_patch_transformed, label_patch_transformed, CA1_patch_transformed,CA2_patch_transformed,CA3_patch_transformed,DG_patch_transformed,MASK_patch_transformed
        ...
        for file_path in file_paths:
            try:
                ...
                dataset = cls(file_path=file_path,
                              ...
                              # mask_internal_path=dataset_config.get('mask_internal_path', 'mask'),
                              label_internal_path=dataset_config.get('label_internal_path', 'label'),
                              CA1_internal_path=dataset_config.get('CA1_internal_path', 'CA1'),
                              CA2_internal_path=dataset_config.get('CA2_internal_path', 'CA2'),
                              CA3_internal_path=dataset_config.get('CA3_internal_path', 'CA3'),
                              DG_internal_path=dataset_config.get('DG_internal_path', 'DG'),
                              MASK_internal_path=dataset_config.get('MASK_internal_path', 'MASK'),
...
class StandardHDF5Dataset(AbstractHDF5Dataset):
    ...
    def __init__(self, file_path, phase, slice_builder_config, transformer_config, mirror_padding=(16, 32, 32),
                 raw_internal_path='raw', label_internal_path='label', CA1_internal_path='CA1',CA2_internal_path='CA2',
                 CA3_internal_path='CA3',DG_internal_path='DG',MASK_internal_path='MASK',weight_internal_path=None,
                 global_normalization=True):
        super().__init__(file_path=file_path,
                         ...
                         # mask_internal_path=mask_internal_path,
                         label_internal_path=label_internal_path,
                         CA1_internal_path=CA1_internal_path,
                         CA2_internal_path=CA2_internal_path,
                         CA3_internal_path=CA3_internal_path,
                         DG_internal_path=DG_internal_path,
                         MASK_internal_path=MASK_internal_path,
...
class LazyHDF5Dataset(AbstractHDF5Dataset):
    ...
    def __init__(self, file_path, phase, slice_builder_config, transformer_config, mirror_padding=(16, 32, 32),
                 raw_internal_path='raw',mask_internal_path='mask', label_internal_path='label',CA1_internal_path='CA1',CA2_internal_path='CA2',
                 CA3_internal_path='CA3',DG_internal_path='DG',MASK_internal_path='MASK',weight_internal_path=None,
